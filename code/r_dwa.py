...
class Robot(object):
    def __init__(self):
        ...
        self.maxVel = 1200.0 # 机器人最大线速度 3000
        self.maxAddVel = 3000.0 # 机器人最大线加速度 3000
        self.maxW = 2.0 # 机器人最大角速度 5.0
        ...
        self.AwayfromObstacle = 1000 # 评价函数中远离障碍物的权重
        self.MaxVelW = 0.001 # 评价函数中速度最大化的权重
        self.RobotStuckLimitV = 10
        self.RobotStuckLimitW = 0.1 # 判断机器人是否被卡住
